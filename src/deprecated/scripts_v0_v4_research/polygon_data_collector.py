...
class PolygonDataCollector:
    ...
    def fetch_daily_bars(self, symbol: str, start_date: str, end_date: str) -> Optional[List[Dict]]:
                ...
                bars.append(
                    {
                        ...
                        "vwap": float(
                            getattr(bar, "vwap", bar.close)
                        ),  # Volume weighted average price
                        "transactions": int(
                            getattr(bar, "transactions", 0)
    ...
    def save_to_cache(self, symbol: str, start_date: str, end_date: str, data: List[Dict]):
    ...
    def collect_symbol_data(
        self, symbol: str, start_date: str = "2024-01-01", end_date: str = "2024-12-31"
    ) -> bool:
    ...
    def collect_all_data(self, start_date: str = "2024-01-01", end_date: str = "2024-12-31"):
    ...
    def verify_data_quality(self):
        ...
        for symbol, result in verification_results.items():
            if "error" in result:
                ...
                print(
                    f"{symbol:6}: {result['data_points']:3} bars, "
...
def main():
    ...
    parser.add_argument(
        "--verify", action="store_true", help="Verify data quality after collection"
    )
