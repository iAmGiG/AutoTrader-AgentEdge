...
Issue #512: Configuration and dataclasses extracted to scanner_config.py
"""
...
# Configuration classes and loaders (Issue #512)
...
class ScannerAgent(BaseAgent):
    ...
    def build_scan_list(self) -> List[str]:  # noqa: C901
        ...
        if strategy_name:
            strategy_tickers = load_strategy_watchlist(strategy_name)
            added = 0
        ...
        discovery_tickers = load_discovery_tickers()
        added = 0
    ...
    def _get_strategy_for_mode(self, mode: str) -> Optional[str]:
        ...
        modes_config = load_trading_modes()
