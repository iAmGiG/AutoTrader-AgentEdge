...
class BaseVotingStrategy(BaseAgent, ABC):
    ...
    def __init__(self, name: str = "BaseVotingStrategy", memory_system=None):
        ...
        super().__init__(
            name=name, tools=tools, memory_system=memory_system, llm_config=voting_llm_config
        )
    ...
    def get_performance_metrics(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "regime_distribution": (
                decisions["regime"].value_counts().to_dict() if "regime" in decisions else {}
            ),
    ...
    def generate_reply(self, messages, context=None) -> str:
        ...
        try:
            ...
            return json.dumps({"action": "HOLD", "confidence": 0.0, "error": str(e)})
