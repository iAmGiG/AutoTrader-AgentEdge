...
class RealVoterStrategy(StrategyAnalyzer):
    ...
    def name(self) -> str:
        """Strategy name."""
        return f"VoterStrategy (MACD+RSI)"
    ...
    async def analyze(self, request: TradeRequest) -> AnalysisResult:
        ...
        try:
            ...
            if market_data is None or market_data.empty:
                ...
                return self._create_fallback_result(ticker, request.price, "No market data available")
            ...
            return AnalysisResult(
                ...
                reasoning=reasoning,
                indicators={
                    'macd_histogram': result['components']['macd']['histogram'] if 'components' in result else 0.0,
                    'rsi_value': result['components']['rsi']['value'] if 'components' in result else 50.0,
    ...
    def _create_fallback_result(self, ticker: str, price: Optional[float], reason: str) -> AnalysisResult:
