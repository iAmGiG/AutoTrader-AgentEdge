...
class LLMTradingAssistant:
    ...
    def handle_adjust_stop(self, request: TradingRequest) -> str:
        ...
        try:
            ...
            current_price = position['market_value'] / abs(position['qty']) if position['qty'] != 0 else position['avg_entry_price']
        ...
        try:
            ...
            if positions:
                ...
                for symbol, pos in positions.items():
                    ...
                    current_price = pos['market_value'] / abs(pos['qty']) if pos['qty'] != 0 else pos['avg_entry_price']
        ...
        try:
            ...
            if not market_status['is_open']:
                ...
                if hours_stale > (7 * 24):  # More than 1 week old
                    ...
                    signal_result['confidence'] = max(0.1, signal_result['confidence'] - staleness_penalty)
