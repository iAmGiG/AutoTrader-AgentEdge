...
def test_cache_hit():
    ...
    data1 = alpaca.get_bars(
        symbols=["AAPL"], start="2024-01-01", end="2024-01-31", timeframe="1Day", feed="iex"
    )
    ...
    if time2 > 0:
        ...
        print("   📝 Note: Cache speedup varies with dataset size and disk I/O")
...
def test_data_quality():
    ...
    data = alpaca.get_bars(
        symbols=["SPY"], start="2024-01-15", end="2024-01-25", timeframe="1Day", feed="iex"
    )
...
if __name__ == "__main__":
    ...
    tests = [test_alpaca_bars, test_cache_hit, test_data_quality]
