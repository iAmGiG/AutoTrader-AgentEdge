...
| QQQ | +5.189% (32 trades) | +-0.271% (26 trades) | +-2.244% (12 trades) | +-1.848% (14 trades) | Not tested | 🔄 Running |
...
| Win Rate % | 20.8% | 18.8% | 25.0% | 21.4% | 20.8% |
| Avg Trade Return % | 0.85% | -0.71% | 1.73% | 0.75% | 0.85% |
...
| Win Rate % | 27.3% | 25.0% | 30.0% | 25.0% | 27.3% |
| Avg Trade Return % | 2.08% | 2.02% | 1.52% | 2.14% | 2.08% |
...
| Win Rate % | 35.0% | 37.5% | 25.0% | 28.6% | 35.0% |
| Avg Trade Return % | 2.43% | 3.08% | 1.74% | 1.62% | 2.43% |
...
| Win Rate % | 27.8% | 31.2% | 40.0% | 41.7% | 27.8% |
| Avg Trade Return % | 5.22% | 1.58% | 11.06% | 4.23% | 5.22% |
...
| Win Rate % | 30.0% | 27.8% | 20.0% | 27.8% | 30.0% |
| Avg Trade Return % | 0.67% | 0.51% | -1.30% | 0.18% | 0.67% |
...
| Win Rate % | 30.8% | 30.8% | 22.2% | 27.3% | 30.8% |
| Avg Trade Return % | 15.74% | 15.74% | 11.48% | 11.55% | 15.74% |
...
| Win Rate % | 28.6% | 25.0% | 40.0% | 40.0% | 28.6% |
| Avg Trade Return % | 0.51% | 0.38% | 0.46% | 0.46% | 0.51% |
...
| Win Rate % | 27.8% | 37.5% | 37.5% | 40.0% | 27.8% |
| Avg Trade Return % | 7.27% | 17.04% | 10.86% | 15.56% | 7.27% |

## 🧠 Strategy Explanations

**V0 (Baseline)**: Pure MACD crossover signals with no sentiment adjustment
**V1 (News Sentiment)**: VADER sentiment analysis of Google Search financial news
**V2 (Market Fear)**: VXX volatility-based fear/complacency sentiment
**V3 (Combined)**: Heuristic combination of V1 news + V2 VXX signals
**V4 (LLM Reasoning)**: GPT-4 intelligent sentiment with date sanitization
...
- Smart news sampling: NewsGovernor reduced API usage by 80-90% while maintaining quality

## ⚙️ Technical Implementation

- **Initial Cash**: $100,000 per test
- **Position Sizing**: Sentiment-based scaling (30%-100% of available cash)
- **Data Sources**: Polygon.io (market), Google Custom Search (news), Alpha Vantage (VXX)
- **News Cache**: Monthly cache with 260 unique articles, 81.5% deduplication rate
- **V4 Date Sanitization**: All dates replaced with generic markers to prevent temporal knowledge

## 🔄 Tests in Progress

Currently running V0-V4 tests for: **QQQ**
